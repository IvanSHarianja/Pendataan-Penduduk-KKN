...
<tr>
    ...
    <td>
        <a href="/kelurahan/<?php echo e($kelurahan->id); ?>/edit" class="btn btn-warning btn-sm">Edit</a>
        <form action="/kelurahan/<?php echo e($kelurahan->id); ?>" method="post" class="d-inline">
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KKN\kependudukan-main\kependudukan-main\resources\views/dashboard/kelurahan/index.blade.php ENDPATH**/ ?>