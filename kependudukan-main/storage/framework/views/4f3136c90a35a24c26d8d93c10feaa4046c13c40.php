                     ...
                     <label class="form-label">Agama</label>
                        <select class="form-select" name="agama_id" aria-label="Default select example">
                            ...
                            <?php $__currentLoopData = $agamas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agama): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if(old('jurusan_id')== $agama->id): ?>
                                    <option value="<?php echo e($agama->id); ?>" selected><?php echo e($agama->nama_agama); ?></option>
                                <?php else: ?>
...
<?php echo $__env->make('dashboard.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\KKN\kependudukan-main\kependudukan-main\resources\views/dashboard/penduduk/create.blade.php ENDPATH**/ ?>