...
<header id="header" class="fixed-top ">
  <div class="container d-flex align-items-center">
    ...
    <h1 class="logo me-auto"><a href="home">Desa Ngargosari</a></h1>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up"
        ...
        <h2>Di Website Data Penduduk Desa Ngargosari Kec. Ampel Boyolali</h2>
        <div class="d-flex justify-content-center justify-content-lg-start">
          <a href="" class="btn-get-started scrollto">LETS GO!</a>
          <!-- <a href="https://youtu.be/FpxLQinZIsE?si=zK00o_UlZt4S9DY2" class="glightbox btn-watch-video"><i
              class="bi bi-play-circle"></i><span>Dokumenter</span></a> -->
        </div>
      </div>
